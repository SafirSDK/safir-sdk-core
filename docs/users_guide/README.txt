...
On a GNU/Linux system it is easy to install the toolchain needed to produce all kinds of documents. Simply install (package names may vary, this is for ubuntu) "asciidoc", "source-highlight", and "dia"
