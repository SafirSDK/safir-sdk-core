...
Currently there are installation packages for Windows, Ubuntu 24.04 and Debian 13. Upon
request we will build for more Linux distributions/versions if feasible.
