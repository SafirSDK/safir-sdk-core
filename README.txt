...
Currently the SDK contains build and install instructions for Windows with Visual Studio, Ubuntu 13.10 and RHEL/Centos 7.x with GCC.
It is possible to adapt these instructions for other compiler and operating system combinations. The SDK currently supports the x86 and x86_64 platforms, with experimental support for ARM.
