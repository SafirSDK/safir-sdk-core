/******************************************************************************
*
* Copyright Saab AB, 2024, 2026 (http://safirsdkcore.com)
*
...
QVariant DobObjectModel::data(const QModelIndex &index, int role) const
{
    ...
    case Qt::DisplayRole:
    {
        ...
        case 2: return item->IsNull() ? QString::fromUtf8("\xE2\x9C\x93") : "";
        case 3: return item->IsChanged() ? QString::fromUtf8("\xE2\x9C\x93") : "";
