...
namespace Utilities
{
    ...
    {
    public:
        explicit ProcessMonitorImpl(boost::asio::io_context& ioContext,
    ...
    private:
        ...
        struct Process
        {
            Process(boost::asio::io_context& ioContext, HANDLE process, const pid_t pid_)
                : handle(ioContext, process)
                , pid(pid_)
            {}
