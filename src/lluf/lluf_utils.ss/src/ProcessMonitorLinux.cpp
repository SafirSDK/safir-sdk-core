...
namespace Utilities
{
        ...
        , m_pollTimer(ioContext)
    {
        ...
        m_pollTimer.async_wait(boost::asio::bind_executor(m_strand,[this](const boost::system::error_code& error){Poll(error);}));
    }
    ...
    void ProcessMonitorImpl::Poll(const boost::system::error_code& error)
    {
            ...
            it != missingPids.end(); ++it)
        {
            ...
            boost::asio::post(m_ioContext,[this,it]{m_callback(*it);});
        }
