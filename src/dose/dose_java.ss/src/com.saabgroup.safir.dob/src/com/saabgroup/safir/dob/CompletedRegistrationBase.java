 ...
 */
public interface CompletedRegistrationBase extends RevokedRegistrationBase
{
    /**
     ...
     * @param handlerId Id of the registered handler.
     */
    void onCompletedRegistration(long typeId,
