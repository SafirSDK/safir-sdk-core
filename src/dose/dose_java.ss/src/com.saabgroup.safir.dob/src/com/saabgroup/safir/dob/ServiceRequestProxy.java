...
public class ServiceRequestProxy {
    ...
    {
        checkNotDisposed();
        return (Service)com.saabgroup.safir.dob.typesystem.ObjectFactory.getInstance().createObject(m_requestBlob);
    }
    ...
    ServiceRequestProxy(java.nio.ByteBuffer requestBlob, java.nio.ByteBuffer state)
    {
    ...
    private void checkNotDisposed()
    {
        if (disposed)
        {
            throw new com.saabgroup.safir.dob.typesystem.SoftwareViolationException("Attempt to use a ServiceRequestProxy that is disposed! Please do not use a ServiceRequestProxy outside the onServiceRequest callback!");
        }
    }
