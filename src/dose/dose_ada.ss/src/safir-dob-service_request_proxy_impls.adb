...
package body Safir.Dob.Service_Request_Proxy_Impls is

   package C renames Interfaces.C;

   function Create (Request_Blob         : in Safir.Dob.Typesystem.Blob_T;
                    State                : in Safir.Dob.Typesystem.Char_Star)
                    return Service_Request_Proxy_Impl_Access is
      Impl_Ptr : Service_Request_Proxy_Impl_Access;
   begin
      Impl_Ptr := new Service_Request_Proxy_Impl;
