...
package body Safir.Dob.Entity_Proxies is

   function Get_Type_Id (Self : in Entity_Proxy)
                         return Safir.Dob.Typesystem.Type_Id is

   begin
      return Safir.Dob.Entity_Proxy_Impls.Get_Type_Id (Self.Impl_Ptr.Get_Raw_Ptr.all);
   end Get_Type_Id;

   function Get_Instance_Id (Self : in Entity_Proxy)
                             return Safir.Dob.Typesystem.Instance_Id.Instance_Id_Type is
   begin
      return Safir.Dob.Entity_Proxy_Impls.Get_Instance_Id (Self.Impl_Ptr.Get_Raw_Ptr.all);
   end Get_Instance_Id;

   function Get_Entity_Id (Self : in Entity_Proxy)
                           return Safir.Dob.Typesystem.Entity_Id.Entity_Id_Type is
   begin
      return Safir.Dob.Entity_Proxy_Impls.Get_Entity_Id (Self.Impl_Ptr.Get_Raw_Ptr.all);
   end Get_Entity_Id;

   function Get_Entity (Self : in Entity_Proxy)
                           return Safir.Dob.Entity.Smart_Pointer'Class is
   begin
      return Safir.Dob.Entity_Proxy_Impls.Get_Entity (Self.Impl_Ptr.Get_Raw_Ptr.all);
   end Get_Entity;

   function Get_Entity_With_Change_Info (Self : in Entity_Proxy)
                                         return Safir.Dob.Entity.Smart_Pointer'Class is
   begin
      return Safir.Dob.Entity_Proxy_Impls.Get_Entity_With_Change_Info (Self.Impl_Ptr.Get_Raw_Ptr.all);
   ...
   begin
      return Safir.Dob.Entity_Proxy_Impls.Get_Owner (Self.Impl_Ptr.Get_Raw_Ptr.all);
   end Get_Owner;

   function Get_Owner_Connection_Info (Self : in Entity_Proxy)
                                       return Safir.Dob.Connection_Info.Smart_Pointer is
   begin
      return Safir.Dob.Entity_Proxy_Impls.Get_Owner_Connection_Info (Self.Impl_Ptr.Get_Raw_Ptr.all);
   end Get_Owner_Connection_Info;

   function Get_Blob (Self : in Entity_Proxy)
                      return Safir.Dob.Typesystem.Blob_T is
   begin
      return Safir.Dob.Entity_Proxy_Impls.Get_Blob (Self.Impl_Ptr.Get_Raw_Ptr.all);
   end Get_Blob;

   function Get_Blob_With_Change_Info (Self : in Entity_Proxy)
                                       return Safir.Dob.Typesystem.Blob_T is
   begin
      return Safir.Dob.Entity_Proxy_Impls.Get_Blob_With_Change_Info (Self.Impl_Ptr.Get_Raw_Ptr.all);
   ...
   begin
      return Safir.Dob.Entity_Proxy_Impls.Get_Previous (Self.Impl_Ptr.Get_Raw_Ptr.all);
   end Get_Previous;

   function Get_Owner_With_String_Representation (Self : in Entity_Proxy)
                                                  return Safir.Dob.Typesystem.Handler_Id.Handler_Id_Type is
   begin
      return Safir.Dob.Entity_Proxy_Impls.Get_Owner_With_String_Representation (Self.Impl_Ptr.Get_Raw_Ptr.all);
   end Get_Owner_With_String_Representation;

   function Get_Timestamp (Self : in Entity_Proxy)
                           return Safir.Dob.Typesystem.Int_64 is
   begin
      return Safir.Dob.Entity_Proxy_Impls.Get_Timestamp (Self.Impl_Ptr.Get_Raw_Ptr.all);
   end Get_Timestamp;
