...
namespace Parser
{
    ...
    typedef std::vector<ClassMemberDefinition> ClassMemberDefinitions;

    /**
     * Definition of a property member.
     */
    struct PropertyMemberDefinition
    {
        std::string Summary;
        std::string Name;
        std::string TypeName;
    ...
    struct ClassDefinition
    {
        ...
        ClassMemberDefinitions Members;
    ...
    struct PropertyDefinition
    {
        ...
        std::string FileName;
        std::string Name;
        PropertyMemberDefinitions Members;
    };
