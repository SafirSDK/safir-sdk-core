...
namespace Parser
{
    ...
    public:
        ...
        /**
         * Get the result after a successfull call to Parse. Will get the complete type system defined at the path
         * specified when parsing.
         *         
         * @return All types, i.e classes, exceptions, enums, properties and property mappings.
         */
        const ParseResult& GetResult() {return m_result;}

        /**
         * Print content of a ParseResult to stdout.
         *
         * @param result [in] - ParseResult to print.
         */
        static void Dump(const ParseResult& result);
