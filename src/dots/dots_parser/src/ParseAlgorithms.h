...
namespace Internal
{
    ...
    {        
        ...
        ParseState(RawParseResultPtr& r) : Result(r) 
        {
    ...
    struct ObjectParameterHandler
    {
        ...
        {
            //TODO:
            //Here we can save quti much time by not calling write_xml, but instead copy or even better store a ref to pt for later parsing.
    ...
    private:
        ...
        const MemberDefinition* GetMember(ClassDefinition& cls, const std::string& name) const;
