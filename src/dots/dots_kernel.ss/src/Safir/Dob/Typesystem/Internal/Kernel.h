...
extern "C"
{
    ...
    DOTS_KERNEL_API DotsC_TypeId CALLING_CONVENTION DotsC_GetTypeId(const char * const blob);
    ...
    DOTS_KERNEL_API DotsC_Int32 CALLING_CONVENTION DotsC_NumberOfTypeIds();

    // Function:    DotsC_NumberOfClasses
    // Parameters:  -
    // Returns:     number of existing classes
    // Comments:    Get the number of classes defined in the system.
    DOTS_KERNEL_API DotsC_Int32 CALLING_CONVENTION DotsC_NumberOfClasses();

    // Function:    DotsC_NumberOfProperties
    // Parameters:  -
    // Returns:     number of existing properties
    // Comments:    Get the number of classes defined in the system.
    DOTS_KERNEL_API DotsC_Int32 CALLING_CONVENTION DotsC_NumberOfProperties();
    ...
    DOTS_KERNEL_API void CALLING_CONVENTION DotsC_GetAllTypeIds(DotsC_TypeId * const buf,
    ...
    DOTS_KERNEL_API bool CALLING_CONVENTION DotsC_TypeExists(const DotsC_TypeId typeId);

    // Function:    DotsC_IsClass
    // Parameters:  typeId - id of class
    // Returns:     true if the type exists as a class
    // Comments:    Check if type id belongs to a existing class
    DOTS_KERNEL_API bool CALLING_CONVENTION DotsC_IsClass(const DotsC_TypeId typeId);
    ...
    DOTS_KERNEL_API bool CALLING_CONVENTION DotsC_IsProperty(const DotsC_TypeId typeId);
    ...
    DOTS_KERNEL_API DotsC_TypeId CALLING_CONVENTION DotsC_TypeIdFromName(const char * const typeName);

    // Function:    DotsC_GetTypeName
    // Parameters:  typeId -    id of type
    // Returns:     name of the type
    // Comments:    Gets the name associated with the specified type id
    DOTS_KERNEL_API const char* CALLING_CONVENTION DotsC_GetTypeName(const DotsC_TypeId typeId);
    ...
    DOTS_KERNEL_API DotsC_Int32 CALLING_CONVENTION DotsC_GetNumberOfEnumerationValues(const DotsC_TypeId enumId);
    ...
    DOTS_KERNEL_API const char* CALLING_CONVENTION DotsC_GetEnumerationValueName(const DotsC_TypeId enumId,
    ...
    DOTS_KERNEL_API DotsC_EnumerationValue CALLING_CONVENTION DotsC_EnumerationValueFromName(const DotsC_TypeId enumId,
    ...
    DOTS_KERNEL_API DotsC_Int32 CALLING_CONVENTION DotsC_GetNumberOfMembers(const DotsC_TypeId typeId);
    ...
    DOTS_KERNEL_API DotsC_MemberIndex     CALLING_CONVENTION DotsC_GetMemberId(const DotsC_TypeId typeId,
    ...
    DOTS_KERNEL_API const char* CALLING_CONVENTION DotsC_GetMemberName(const DotsC_TypeId typeId,
                                                                       const DotsC_MemberIndex member);
    ...
    //              member is of.
    DOTS_KERNEL_API DotsC_TypeId CALLING_CONVENTION DotsC_GetComplexMemberTypeId(const DotsC_TypeId typeId,
                                                                                 const DotsC_MemberIndex member);
    ...
    DOTS_KERNEL_API void CALLING_CONVENTION DotsC_GetMemberInfo(const DotsC_TypeId typeId,  //in
    ...
    DOTS_KERNEL_API DotsC_Int32 CALLING_CONVENTION DotsC_GetMemberArraySize(const DotsC_TypeId typeId,
                                                                            const DotsC_MemberIndex member);
    ...
    DOTS_KERNEL_API DotsC_Int32 CALLING_CONVENTION DotsC_GetStringMemberMaxLength(const DotsC_TypeId typeId,
                                                                                  const DotsC_MemberIndex member);
    ...
    DOTS_KERNEL_API const char* CALLING_CONVENTION DotsC_GetMemberTypeName(const DotsC_TypeId typeId,
                                                                           const DotsC_MemberIndex member);
    ...
    DOTS_KERNEL_API DotsC_Int32 CALLING_CONVENTION DotsC_GetNumberOfParameters(const DotsC_TypeId typeId);
    ...
    DOTS_KERNEL_API DotsC_ParameterIndex  CALLING_CONVENTION DotsC_GetParameterId(const DotsC_TypeId typeId,
    ...
    DOTS_KERNEL_API const char* CALLING_CONVENTION DotsC_GetParameterName(const DotsC_TypeId typeId,
    ...
    //              If the parameter does not exist the return value is undefined. Use GetParameterId
    //              to obtain a parameter that is guaranteed to exist.
    DOTS_KERNEL_API DotsC_MemberType CALLING_CONVENTION DotsC_GetParameterType(const DotsC_TypeId typeId,
                                                                               const DotsC_ParameterIndex parameter);
    ...
    //              If the parameter does not exist the return value is undefined. Use GetParameterId
    //              to obtain a parameter that is guaranteed to exist.
    DOTS_KERNEL_API const char* CALLING_CONVENTION DotsC_GetParameterTypeName(const DotsC_TypeId typeId,
                                                                              const DotsC_ParameterIndex parameter);
    ...
    //              If the parameter does not exist the return value is undefined. Use GetParameterId
    //              to obtain a parameter that is guaranteed to exist.
    DOTS_KERNEL_API DotsC_Int32 CALLING_CONVENTION DotsC_GetParameterArraySize(const DotsC_TypeId typeId,
                                                                               const DotsC_ParameterIndex parameter);
    ...
    DOTS_KERNEL_API bool CALLING_CONVENTION DotsC_IsOfType(const DotsC_TypeId type,
    ...
    DOTS_KERNEL_API void CALLING_CONVENTION DotsC_GetCompleteType(const DotsC_TypeId type,
    ...
    DOTS_KERNEL_API void CALLING_CONVENTION DotsC_HasProperty(const DotsC_TypeId classTypeId,
    ...
    */
    ...
    // Returns:     -
    // Comments:    Serializes a blob to a xml string.
    DOTS_KERNEL_API void CALLING_CONVENTION DotsC_BetterBlobToXml(char * const xmlDest,
    ...
    DOTS_KERNEL_API DotsC_Int32 CALLING_CONVENTION DotsC_CalculateBase64BufferSize(const DotsC_Int32 binarySourceSize);
    ...
    DOTS_KERNEL_API void CALLING_CONVENTION DotsC_BinaryToBase64(char * const base64Dest,
    ...
    DOTS_KERNEL_API DotsC_Int32 CALLING_CONVENTION DotsC_CalculateBinaryBufferSize(const DotsC_Int32 base64SourceSize);
    ...
    DOTS_KERNEL_API void CALLING_CONVENTION DotsC_Base64ToBinary(char * const binaryDest,
                                                                 const DotsC_Int32 destSize,
    ...
    DOTS_KERNEL_API void CALLING_CONVENTION DotsC_GetBooleanParameter(const DotsC_TypeId typeId,
                                                                      const DotsC_ParameterIndex parameter,
                                                                      const DotsC_ArrayIndex index,
                                                                      bool & val);
    ...
    DOTS_KERNEL_API void CALLING_CONVENTION DotsC_GetEnumerationParameter(const DotsC_TypeId typeId,
                                                                          const DotsC_ParameterIndex parameter,
                                                                          const DotsC_ArrayIndex index,
    ...
    DOTS_KERNEL_API void CALLING_CONVENTION DotsC_GetInt32Parameter(const DotsC_TypeId typeId,
                                                                    const DotsC_ParameterIndex parameter,
                                                                    const DotsC_ArrayIndex index,
                                                                    DotsC_Int32 & val);
    ...
    DOTS_KERNEL_API void CALLING_CONVENTION DotsC_GetInt64Parameter(const DotsC_TypeId typeId,
                                                                    const DotsC_ParameterIndex parameter,
                                                                    const DotsC_ArrayIndex index,
                                                                    DotsC_Int64 & val);
    ...
    DOTS_KERNEL_API void CALLING_CONVENTION DotsC_GetFloat32Parameter(const DotsC_TypeId typeId,
                                                                      const DotsC_ParameterIndex parameter,
                                                                      const DotsC_ArrayIndex index,
                                                                      DotsC_Float32 & val);
    ...
    DOTS_KERNEL_API void CALLING_CONVENTION DotsC_GetFloat64Parameter(const DotsC_TypeId typeId,
                                                                      const DotsC_ParameterIndex parameter,
                                                                      const DotsC_ArrayIndex index,
                                                                      DotsC_Float64 & val);
    ...
    DOTS_KERNEL_API void CALLING_CONVENTION DotsC_GetStringParameter(const DotsC_TypeId typeId,
                                                                     const DotsC_ParameterIndex parameter,
                                                                     const DotsC_ArrayIndex index,
                                                                     const char * & val);
    ...
    DOTS_KERNEL_API void CALLING_CONVENTION DotsC_GetTypeIdParameter(const DotsC_TypeId typeId,
                                                                     const DotsC_ParameterIndex parameter,
                                                                     const DotsC_ArrayIndex index,
                                                                     DotsC_TypeId & val);
    ...
    DOTS_KERNEL_API void CALLING_CONVENTION DotsC_GetHashedIdParameter(const DotsC_TypeId typeId,
                                                                       const DotsC_ParameterIndex parameter,
                                                                       const DotsC_ArrayIndex index,
                                                                       DotsC_Int64 & hashVal,
                                                                       const char * & strVal);
    ...
    DOTS_KERNEL_API void CALLING_CONVENTION DotsC_GetEntityIdParameter(const DotsC_TypeId typeId,
                                                                       const DotsC_ParameterIndex parameter,
                                                                       const DotsC_ArrayIndex index,
    ...
    DOTS_KERNEL_API void CALLING_CONVENTION DotsC_GetObjectParameter(const DotsC_TypeId typeId,
                                                                     const DotsC_ParameterIndex parameter,
                                                                     const DotsC_ArrayIndex index,
                                                                     const char * & val);
    ...
    DOTS_KERNEL_API void CALLING_CONVENTION DotsC_GetBooleanMember(const char * const blob,
                                                                   const DotsC_MemberIndex member,
                                                                   const DotsC_ArrayIndex index,
                                                                   bool & val,
                                                                   bool & isNull,
    ...
    DOTS_KERNEL_API void CALLING_CONVENTION DotsC_GetInt32Member(const char * const blob,
                                                                 const DotsC_MemberIndex member,
                                                                 const DotsC_ArrayIndex index,
                                                                 DotsC_Int32 & val,
                                                                 bool & isNull,
    ...
    DOTS_KERNEL_API void CALLING_CONVENTION DotsC_GetInt64Member(const char * const blob,
                                                                 const DotsC_MemberIndex member,
                                                                 const DotsC_ArrayIndex index,
                                                                 DotsC_Int64 & val,
                                                                 bool & isNull,
    ...
    DOTS_KERNEL_API void CALLING_CONVENTION DotsC_GetFloat32Member(const char * const blob,
                                                                   const DotsC_MemberIndex member,
                                                                   const DotsC_ArrayIndex index,
                                                                   DotsC_Float32 & val,
                                                                   bool & isNull,
    ...
    DOTS_KERNEL_API void CALLING_CONVENTION DotsC_GetFloat64Member(const char * const blob,
                                                                   const DotsC_MemberIndex member,
                                                                   const DotsC_ArrayIndex index,
                                                                   DotsC_Float64 & val,
                                                                   bool & isNull,
    ...
    DOTS_KERNEL_API void CALLING_CONVENTION DotsC_GetStringMember(const char * const blob,
                                                                  const DotsC_MemberIndex member,
                                                                  const DotsC_ArrayIndex index,
                                                                  const char * & val,
                                                                  bool & isNull,
    ...
    DOTS_KERNEL_API void CALLING_CONVENTION DotsC_GetHashedIdMember(const char * const blob,
                                                                    const DotsC_MemberIndex member,
                                                                    const DotsC_ArrayIndex index,
                                                                    DotsC_Int64 & hashVal,
                                                                    const char * & strVal,
    ...
    // Returns:     -
    // Comments:    Get a object id member from a blob.
    DOTS_KERNEL_API void CALLING_CONVENTION DotsC_GetEntityIdMember(const char * const blob,
                                                                    const DotsC_MemberIndex member,
                                                                    const DotsC_ArrayIndex index,
                                                                    DotsC_EntityId & entityId,
                                                                    const char * & instanceIdStr,
    ...
    DOTS_KERNEL_API void CALLING_CONVENTION DotsC_GetObjectMember(const char * const blob,
                                                                  const DotsC_MemberIndex member,
                                                                  const DotsC_ArrayIndex index,
                                                                  const char * & val,
                                                                  bool & isNull,
    ...
    // Returns:     -
    // Comments:    Get a object member from a blob.
    DOTS_KERNEL_API void CALLING_CONVENTION DotsC_GetBinaryMember(const char * const blob,
                                                                  const DotsC_MemberIndex member,
                                                                  const DotsC_ArrayIndex index,
                                                                  const char * & val,
                                                                  DotsC_Int32 & size,
    ...
    DOTS_KERNEL_API void CALLING_CONVENTION DotsC_SetNullMember(char * const blob,
                                                                const DotsC_MemberIndex member,
                                                                const DotsC_ArrayIndex index);
    ...
    DOTS_KERNEL_API DotsC_Int32 CALLING_CONVENTION DotsC_GetInitialSize(const DotsC_TypeId typeId);

    DOTS_KERNEL_API void CALLING_CONVENTION DotsC_FormatBlob(char * const blob,
                                                             const DotsC_Int32 blobSize,
                                                             const DotsC_TypeId typeId,
                                                             char * & beginningOfUnused);

    DOTS_KERNEL_API void CALLING_CONVENTION DotsC_CreateObjectMember(char * const insideBlob,
                                                                     const DotsC_Int32 blobSize,
                                                                     const DotsC_TypeId typeId,
                                                                     const DotsC_MemberIndex member,
                                                                     const DotsC_ArrayIndex index,
    ...
    DOTS_KERNEL_API void CALLING_CONVENTION DotsC_CreateStringMember(char * const insideBlob,
    ...
    DOTS_KERNEL_API void CALLING_CONVENTION DotsC_CreateBinaryMember(char * const insideBlob,
    ...
    DOTS_KERNEL_API void CALLING_CONVENTION DotsC_SetBooleanMemberInPreallocated(const bool val,
                                                                                 const bool isNull,
                                                                                 const bool isChanged,
                                                                                 char * const blob,
                                                                                 const DotsC_MemberIndex member,
                                                                                 const DotsC_ArrayIndex index);
    /*
      DOTS_KERNEL_API void CALLING_CONVENTION DotsC_SetEnumerationMemberInPreallocated(const DotsC_EnumerationValue val,
      const bool isNull,
      const bool isChanged,
      char * const blob,
      const DotsC_MemberIndex member,
    ...
    */
    DOTS_KERNEL_API void CALLING_CONVENTION DotsC_SetInt32MemberInPreallocated(const DotsC_Int32 val,
                                                                               const bool isNull,
                                                                               const bool isChanged,
                                                                               char * const blob,
                                                                               const DotsC_MemberIndex member,
    ...
    DOTS_KERNEL_API void CALLING_CONVENTION DotsC_SetInt64MemberInPreallocated(const DotsC_Int64 val,
                                                                               const bool isNull,
                                                                               const bool isChanged,
                                                                               char * const blob,
                                                                               const DotsC_MemberIndex member,
    ...
    DOTS_KERNEL_API void CALLING_CONVENTION DotsC_SetFloat32MemberInPreallocated(const DotsC_Float32 val,
                                                                                 const bool isNull,
                                                                                 const bool isChanged,
                                                                                 char * const blob,
                                                                                 const DotsC_MemberIndex member,
    ...
    DOTS_KERNEL_API void CALLING_CONVENTION DotsC_SetFloat64MemberInPreallocated(const DotsC_Float64 val,
                                                                                 const bool isNull,
                                                                                 const bool isChanged,
                                                                                 char * const blob,
                                                                                 const DotsC_MemberIndex member,
    ...
    DOTS_KERNEL_API void CALLING_CONVENTION DotsC_SetHashedIdMemberInPreallocated(const DotsC_Int64 hashVal,
                                                                                  const char * const strVal,
    ...
    DOTS_KERNEL_API void CALLING_CONVENTION DotsC_SetEntityIdMemberInPreallocated(const DotsC_EntityId & entityId,
                                                                                  const char * const instanceIdStr,
                                                                                  const DotsC_Int32 stringLength,
                                                                                  const bool isNull,
                                                                                  const bool isChanged,
    ...
    DOTS_KERNEL_API void CALLING_CONVENTION DotsC_GetPropertyMappingKind(const DotsC_TypeId typeId,
                                                                         const DotsC_TypeId propertyId,
                                                                         const DotsC_MemberIndex member,
                                                                         DotsC_PropertyMappingKind & mappingKind,
                                                                         DotsC_ErrorCode & errorCode);

    DOTS_KERNEL_API void CALLING_CONVENTION DotsC_GetClassMemberReference(const DotsC_TypeId typeId,
                                                                          const DotsC_TypeId propertyId,
                                                                          const DotsC_MemberIndex member,
                                                                          const DotsC_Int32 * & classMemberReference, //out
                                                                          DotsC_Int32 & classMemberReferenceSize); //out

    DOTS_KERNEL_API void CALLING_CONVENTION DotsC_GetEnumerationChecksum(const DotsC_TypeId typeId,
    ...
    // Returns:     -
    // Comments:    Gets a parameter boolean value.
    DOTS_KERNEL_API void CALLING_CONVENTION DotsC_GetBooleanPropertyParameter(const DotsC_TypeId typeId,
                                                                              const DotsC_TypeId propertyId,
                                                                              const DotsC_MemberIndex member,
                                                                              const DotsC_ArrayIndex index,
                                                                              bool & val);
    ...
    // Returns:     -
    // Comments:    Gets a parameter enumeration value.
    DOTS_KERNEL_API void CALLING_CONVENTION DotsC_GetEnumerationPropertyParameter(const DotsC_TypeId typeId,
                                                                                  const DotsC_TypeId propertyId,
                                                                                  const DotsC_MemberIndex member,
                                                                                  const DotsC_ArrayIndex index,
                                                                                  DotsC_EnumerationValue & val);
    ...
    // Returns:     -
    // Comments:    Gets a parameter 32-bits integer value.
    DOTS_KERNEL_API void CALLING_CONVENTION DotsC_GetInt32PropertyParameter(const DotsC_TypeId typeId,
                                                                            const DotsC_TypeId propertyId,
                                                                            const DotsC_MemberIndex member,
                                                                            const DotsC_ArrayIndex index,
                                                                            DotsC_Int32 & val);
    ...
    // Returns:     -
    // Comments:    Gets a parameter 64-bits integer value.
    DOTS_KERNEL_API void CALLING_CONVENTION DotsC_GetInt64PropertyParameter(const DotsC_TypeId typeId,
                                                                            const DotsC_TypeId propertyId,
                                                                            const DotsC_MemberIndex member,
                                                                            const DotsC_ArrayIndex index,
                                                                            DotsC_Int64 & val);
    ...
    // Returns:     -
    // Comments:    Gets a parameter 32-bits float value.
    DOTS_KERNEL_API void CALLING_CONVENTION DotsC_GetFloat32PropertyParameter(const DotsC_TypeId typeId,
                                                                              const DotsC_TypeId propertyId,
                                                                              const DotsC_MemberIndex member,
                                                                              const DotsC_ArrayIndex index,
                                                                              DotsC_Float32 & val);
    ...
    // Returns:     -
    // Comments:    Gets a parameter 64-bits float value.
    DOTS_KERNEL_API void CALLING_CONVENTION DotsC_GetFloat64PropertyParameter(const DotsC_TypeId typeId,
                                                                              const DotsC_TypeId propertyId,
                                                                              const DotsC_MemberIndex member,
                                                                              const DotsC_ArrayIndex index,
                                                                              DotsC_Float64 & val);
    ...
    // Returns:     -
    // Comments:    Gets a parameter string value.
    DOTS_KERNEL_API void CALLING_CONVENTION DotsC_GetStringPropertyParameter(const DotsC_TypeId typeId,
                                                                             const DotsC_TypeId propertyId,
                                                                             const DotsC_MemberIndex member,
                                                                             const DotsC_ArrayIndex index,
                                                                             const char * & val);
    ...
    // Returns:     -
    // Comments:    Gets a parameter object id value.
    DOTS_KERNEL_API void CALLING_CONVENTION DotsC_GetHashedIdPropertyParameter(const DotsC_TypeId typeId,
                                                                               const DotsC_TypeId propertyId,
                                                                               const DotsC_MemberIndex member,
                                                                               const DotsC_ArrayIndex index,
                                                                               DotsC_Int64 & hashVal,
    ...
    // Returns:     -
    // Comments:    Gets a parameter object id value.
    DOTS_KERNEL_API void CALLING_CONVENTION DotsC_GetEntityIdPropertyParameter(const DotsC_TypeId typeId,
                                                                               const DotsC_TypeId propertyId,
                                                                               const DotsC_MemberIndex member,
                                                                               const DotsC_ArrayIndex index,
                                                                               DotsC_EntityId & val,
    ...
    // Returns:     -
    // Comments:    Gets a parameter object value.
    DOTS_KERNEL_API void CALLING_CONVENTION DotsC_GetObjectPropertyParameter(const DotsC_TypeId typeId,
                                                                             const DotsC_TypeId propertyId,
                                                                             const DotsC_MemberIndex member,
                                                                             const DotsC_ArrayIndex index,
                                                                             const char * & val);
    ...
    // Returns:     -
    // Comments:    Gets a parameter object value.
    DOTS_KERNEL_API void CALLING_CONVENTION DotsC_GetBinaryPropertyParameter(const DotsC_TypeId typeId,
                                                                             const DotsC_TypeId propertyId,
                                                                             const DotsC_MemberIndex member,
                                                                             const DotsC_ArrayIndex index,
                                                                             const char * & val,
    ...
    DOTS_KERNEL_API void CALLING_CONVENTION DotsC_SetException(const DotsC_TypeId exceptionId,
