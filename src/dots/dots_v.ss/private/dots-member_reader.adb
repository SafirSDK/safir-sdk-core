...
--      File_Name : constant Unbounded_String := To_Unbounded_String (Get_Public_Id (Handler.Locator));   -- XML ADA 3.2.1
      File_Name : constant Unbounded_String := To_Unbounded_String (Sax.Symbols.Get (Get_Public_Id (Handler.Locator)).all);     -- XML ADA 4.2
