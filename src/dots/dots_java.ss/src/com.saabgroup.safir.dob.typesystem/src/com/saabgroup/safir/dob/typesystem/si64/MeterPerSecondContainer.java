...
/**
 * Container for MeterPerSecond64 members.
 */
public class MeterPerSecondContainer
     ...
     * Default constructor.
     */
    public MeterPerSecondContainer(){
        super();
    }

    /**
     * Construct an MeterPerSecondContainer from value and flags.
     *
     ...
     */
    public MeterPerSecondContainer(double value, boolean isNull, boolean isChanged) {
