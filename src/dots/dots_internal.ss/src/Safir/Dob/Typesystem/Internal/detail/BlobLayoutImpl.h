...
#ifndef __DOTS_INTERNAL_DETAIL_BLOBLAYOUTIMPL_H__
#define __DOTS_INTERNAL_DETAIL_BLOBLAYOUTIMPL_H__
...
public:
    ...
    private:
        ...
        bool IsOfType(TypeId theType, TypeId ofType) const
        {
            ...
            const ClassDescriptionType* tmpClass=m_repository->GetClass(theType);
            while (tmpClass)
            {
