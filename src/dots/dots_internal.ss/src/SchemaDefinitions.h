...
namespace ToolSupport
{
    namespace Schema
    {
        ...
        typedef Element<Elements::ParameterSequence, One, boost::mpl::vector<IgnoreAny> > ParameterSequence;
        typedef Element<Elements::ParameterSet, One, boost::mpl::vector<IgnoreAny> > ParameterSet;
