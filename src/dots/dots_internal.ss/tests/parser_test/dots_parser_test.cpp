...
bool RunSingleTest(const TestCase& test)
{
    ...
    try
    {
        std::shared_ptr<const Safir::Dob::Typesystem::ToolSupport::TypeRepository> rep=Safir::Dob::Typesystem::ToolSupport::ParseTypeDefinitionsDir(test.path);
        if (PrintRepository)
        {
...
void ParseDir(const boost::filesystem::path& dir)
{
    ...
    try
    {
        std::shared_ptr<const Safir::Dob::Typesystem::ToolSupport::TypeRepository> rep=Safir::Dob::Typesystem::ToolSupport::ParseTypeDefinitionsDir(dir);
