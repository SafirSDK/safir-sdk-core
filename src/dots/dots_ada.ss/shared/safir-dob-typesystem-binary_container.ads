...
-- Container and related container proxy for Binary.
--
...
package Safir.Dob.Typesystem.Binary_Container is
   ...
   procedure Set_Val (Self  : in out Container;
                      Value : in Binary_Vectors.Vector);
   ...
   --
   function Get_Val (Self : in Container) return access constant Binary_Vectors.Vector;
   ...
   --
   function "=" (Self : in Container; Right : in Binary_Vectors.Vector) return Boolean;

   -- Equality operator that enables expressions of the form
   -- Contained_Type = Container.
   --
   function "=" (Left : in Binary_Vectors.Vector; Self : in Container) return Boolean;
   ...
   ------------------------
   -- Binary_Container_Proxy
   --
   -- This is the type returned from generated member functions. The main
   -- purpose is to encapsulate the pointer to the Binary_Container. If
   ...
   -- Exceptions: Null_Exception - The container is null.
   --
   function Get_Val (Self : in Container_Proxy'Class) return access constant Binary_Vectors.Vector;
   ...
   -- the values are not equal. The change flag is ignored.
   --
   function "=" (Self : in Container_Proxy'Class; Right : in Binary_Vectors.Vector) return Boolean;

   -- Equality operator that enables expressions of the form
   -- Contained_Type = Container.
   --
   function "=" (Left : in Binary_Vectors.Vector; Self : in Container_Proxy'Class) return Boolean;
...
private
   type Container is new Container_Base_Type with record
      ...
      Value               : aliased Binary_Vectors.Vector;
   end record;
