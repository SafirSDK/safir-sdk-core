...
package body Safir.Dob.Typesystem.Value_Container is
   ...
   function Get_Val (Self : in Container) return Contained_Type is
   begin
   ...
   function "=" (Self : in Container; Right : in Contained_Type) return Boolean is
   begin
      return not Self.Is_Null and then Self.Value = Right;
   end "=";

   function "=" (Left : in Contained_Type; Self : in Container) return Boolean is
   begin
   ...
   -----------------------------------
   -- Value_Container_Proxy operations
   -----------------------------------
   ...
   function Get_Val (Self : in Container_Proxy'Class) return Contained_Type is
   begin
   ...
   function "=" (Self : in Container_Proxy'Class; Right : in Contained_Type) return Boolean is
   begin
      return Self.Container_Ptr.all = Right;
   end "=";


   function "=" (Left : in Contained_Type; Self : in Container_Proxy'Class) return Boolean is
   begin
