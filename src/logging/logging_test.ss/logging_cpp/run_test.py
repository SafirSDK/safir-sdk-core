...
if syslog_output.count("No c++20 format support") == 3:
    verify_log_message(syslog_output, 16, "No c++20 format support", 6, 3)
else:
    # Verify formatted logs also use Local0 facility
    verify_log_message(syslog_output, 16, "This is another emergency log. Parameters: 10 and bertil", 0, 3)
    verify_log_message(syslog_output, 16, "This is another alert log. Parameters: 10 and bertil", 1, 3)
    verify_log_message(syslog_output, 16, "This is another critical log. Parameters: 10 and bertil", 2, 3)
    verify_log_message(syslog_output, 16, "This is another error log. Parameters: 10 and bertil", 3, 3)
    verify_log_message(syslog_output, 16, "This is another warning log. Parameters: 10 and bertil", 4, 3)
    verify_log_message(syslog_output, 16, "This is another notice log. Parameters: 10 and bertil", 5, 3)
    verify_log_message(syslog_output, 16, "This is another informational log. Parameters: 10 and bertil", 6, 3)
    verify_log_message(syslog_output, 16, "This is another debug log. Parameters: 10 and bertil", 7, 3)
