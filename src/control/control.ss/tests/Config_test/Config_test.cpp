...
int main(int argc, char* argv[])
{
    ...
    if (test == "tc1")
    {
        ...
        CHECK(nodeTypes[0].multicastAddress == "192.0.0.1");
        CHECK(nodeTypes[0].controlPort == 9500);
        CHECK(nodeTypes[0].dataPort == 9501);
        ...
        CHECK(nodeTypes[1].multicastAddress == "192.0.0.15");
        CHECK(nodeTypes[1].controlPort == 9500);
        CHECK(nodeTypes[1].dataPort == 9501);
        ...
        CHECK(nodeTypes[2].multicastAddress == "192.0.0.16");
        CHECK(nodeTypes[2].controlPort == 9500);
        CHECK(nodeTypes[2].dataPort == 9501);
