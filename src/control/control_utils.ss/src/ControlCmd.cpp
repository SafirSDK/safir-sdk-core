...
namespace
{
    ...
    ControlCmdReceiver::ControlCmdReceiver(boost::asio::io_context&     ioContext,
                                           const CmdCb&                 cmdCb)
    ...
    public:
        ...
        Impl(boost::asio::io_context&       ioContext,
            ...
            : m_ipcPublisher(ioContext, controlCmdChannel, controlConnectedCb, NULL)
        {
        }
    ...
    ControlCmdSender::ControlCmdSender(boost::asio::io_context&       ioContext,
                                       const std::function<void()>    controlConnectedCb)
        : m_impl(Safir::make_unique<Impl>(ioContext, controlConnectedCb))
    {
    }
