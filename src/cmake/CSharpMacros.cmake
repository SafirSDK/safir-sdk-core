function(ADD_CSHARP_ASSEMBLY TARGET_NAME)
    ...
    if (_cs_LIBRARY)
      set (_cs_target "${CMAKE_CSHARP_OUTPUT_DIRECTORY}/${TARGET_NAME}.dll")
      set (_cs_target_kind library)
      set (_cs_doc_file "${CMAKE_CSHARP_OUTPUT_DIRECTORY}/${TARGET_NAME}.xml")
      set (_cs_flags "${_cs_flags} -doc:\"${_cs_doc_file}\"")
    elseif (_cs_EXE)
      set (_cs_target "${CMAKE_CSHARP_OUTPUT_DIRECTORY}/${TARGET_NAME}.exe")
    ...
    if (CSHARP_IS_MONO)
      ...
      set (_cs_debug_file "${CMAKE_CSHARP_OUTPUT_DIRECTORY}/${TARGET_NAME}.pdb")
    endif()
