...
pipeline {
    parameters {
        choice(name: 'PLATFORM_FILTER',
               choices: ['all', 'ubuntu-noble', 'debian-bookworm', 'debian-trixie', 'vs2015', 'vs2019', 'vs2022'],
        ...
        stage('Build') {
            matrix {
                ...
                axes {
                    axis {
                        name 'BUILD_PLATFORM'
                        values 'ubuntu-noble', 'debian-bookworm', 'debian-trixie', 'vs2015', 'vs2019', 'vs2022'
                    }
                    axis {
                        name 'BUILD_ARCH'
                        values 'x86', 'amd64'
                ...
                excludes {
                    exclude {
                        axis { //ubuntu no longer support 32 bit builds, and we have dropped support for 32 bit bookworm
                            name 'BUILD_PLATFORM'
                            values 'ubuntu-noble', 'debian-bookworm'
                        }
                        axis {
                            name 'BUILD_ARCH'
                            values 'x86'
