...
MACRO(ADD_CS_RESOURCES resources resource_prefix working_directory)
  ...
  FOREACH(resx_file ${proper_resources})
    ...
    #with mono we call an external script to compile, see comments in mono_resgen.cmake
    IF (CSHARP_IS_MONO)
      ADD_CUSTOM_COMMAND(OUTPUT ${resource_file}
        COMMAND ${CMAKE_COMMAND} 
        ARGS -Dresx_file=${resx_file} -Dresource_file=${resource_file} -DRESGEN_EXECUTABLE=${RESGEN_EXECUTABLE} -P ${SAFIR_SDK}/data/build/mono_resgen.cmake
        DEPENDS ${resx_file}
